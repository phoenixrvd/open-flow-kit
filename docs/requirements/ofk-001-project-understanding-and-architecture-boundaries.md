...
OpenFlowKit provides instructions, skills, and workflow building blocks for AI-assisted automation of development and team processes. The project is designed for pragmatic use in real software projects and is intended to structure recurring engineering tasks without prescribing a closed automation system, installer, CLI, or runtime.
...
OpenFlowKit is provided as a public source project hosted on GitHub. The documented project context distinguishes between the OpenFlowKit source and target projects into which skills and workflow building blocks are installed.
...
- GitHub serves as the central source for the provided instructions, skills, requirements, and workflow building blocks.
...
**Type:** Non-functional  
**Description:** OpenFlowKit must support functional reuse and local adaptation of skills, instructions, and workflows.
**Acceptance Criteria:**
- The public GitHub structure remains traceable as a source for reuse.
- Content can be adapted to project context.
- Teams can modify skills, instructions, and workflows locally.
- The repository intentionally remains readable and free of unnecessary runtime dependencies.
  **References:** Project context

### Security Boundary
**Type:** Constraint  
**Description:** OpenFlowKit must treat skills, prompts, and instructions as potentially effective automation artifacts and leave responsibility for safe use with the user.
**Acceptance Criteria:**
- Skills, prompts, and instructions are treated like executable code.
- Users are responsible for reviews, permissions, system access, secret handling, and their own sandbox strategies.
- OpenFlowKit does not guarantee that provided or merged skills are safe in every project context.
  **References:** Project context
